    ...
    const fetchProductsData = async () => {
      try {
        const response = await axios.get(
          "http://localhost:3000/product/available"
        );
            ...
            >
              <div className="flex justify-center items-center bg-white shadow-md rounded-lg p-4 mb-4 w-11/12 lg:w-3/4 mx-auto transition-transform transform hover:scale-105 hover:shadow-lg">
                <img
                  alt={product.name}
                  src={product.image}
                  className="w-40 h-auto object-contain rounded-lg mr-4"
                />
                <div className="flex-1 text-left">
                  <div className="mb-2">
                    ...
                    <p className="text-gray-700 text-xs md:text-sm lg:text-base mb-1">
                      Price: ${product.price}
                    </p>
                  </div>
                  <div className="mb-2">
